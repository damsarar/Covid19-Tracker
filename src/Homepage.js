                                ...
                                <Container style={{textAlign: "center"}} className="pr-0">
                                    ...
                                    <Row style={{width: "100%"}} className="pr-0">
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="New Cases"
                                                      value={this.seperator(this.state.dataArray.local_new_cases)}
                                                      color="#025E97"></StatCard>
                                        </Col>

                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Cases"
                                                      value={this.seperator(this.state.dataArray.local_total_cases)}
                                                      color="#FF9700 "></StatCard>
                                        </Col>
                                    </Row>
                                    <Row style={{width: "100%"}} className="pr-0">
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Deaths"
                                                      value={this.seperator(this.state.dataArray.local_deaths)}
                                                      color="#D80505"></StatCard>
                                        </Col>
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Recovered"
                                                      value={this.seperator(this.state.dataArray.local_recovered)}
                                                      color="#5AA001"></StatCard>
                                        </Col>
                                    </Row>
                                </Container>
                            ...
                            <Col xs={12} md={6} className="mt-4 pr-0">
                                <Container style={{width: "100%"}} className="pr-0">
                                    ...
                                    <Row style={{width: "100%"}} className="pr-0">
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="New Cases"
                                                      value={this.seperator(this.state.dataArray.global_new_cases)}
                                                      color="#025E97"></StatCard>
                                        </Col>
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Cases"
                                                      value={this.seperator(this.state.dataArray.global_total_cases)}
                                                      color="#FF9700 "></StatCard>
                                        </Col>
                                    </Row>
                                    <Row style={{width: "100%",}} className="pr-0">
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Deaths"
                                                      value={this.seperator(this.state.dataArray.global_deaths)}
                                                      color="#D80505"></StatCard>
                                        </Col>
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Recovered"
                                                      value={this.seperator(this.state.dataArray.global_recovered)}
                                                      color="#5AA001"></StatCard>
                                        </Col>
                                    </Row>
                                </Container>
