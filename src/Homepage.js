...
class Homepage extends React.Component {
    ...
    async fetchCurrentStat() {
        const COVID19_API_CURRENT_STAT_URL = "https://hpb.health.gov.lk/api/get-current-statistical";
        const response = await fetch(COVID19_API_CURRENT_STAT_URL);
        return response.json();
    }

    async componentDidMount() {
        try {
            const results = await this.fetchCurrentStat();
        ...
        return (
            <div>
                        ...
                        <Row style={{ width: "100%" }} className="pr-0">
                                ...
                                <Container style={{ textAlign: "center" }} className="pr-0">
                                    ...
                                    <Row style={{ width: "100%" }} className="pr-0">
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="New Cases" value={this.separator(this.state.dataArray.local_new_cases)} color="#025E97"></StatCard>
                                        </Col>

                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Cases" value={this.separator(this.state.dataArray.local_total_cases)} color="#FF9700 "></StatCard>
                                        </Col>
                                    </Row>
                                    <Row style={{ width: "100%" }} className="pr-0">
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Deaths" value={this.separator(this.state.dataArray.local_deaths)} color="#D80505"></StatCard>
                                        </Col>
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Recovered" value={this.separator(this.state.dataArray.local_recovered)} color="#5AA001"></StatCard>
                                        </Col>
                                    </Row>
                                </Container>
                            </Col>
                            ...
                            <Col xs={12} md={6} className="mt-4 pr-0">
                                <Container style={{ width: "100%" }} className="pr-0">
                                    ...
                                    <Row style={{ width: "100%" }} className="pr-0">
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="New Cases" value={this.separator(this.state.dataArray.global_new_cases)} color="#025E97"></StatCard>
                                        </Col>
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Cases" value={this.separator(this.state.dataArray.global_total_cases)} color="#FF9700 "></StatCard>
                                        </Col>
                                    </Row>
                                    <Row style={{ width: "100%" }} className="pr-0">
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Deaths" value={this.separator(this.state.dataArray.global_deaths)} color="#D80505"></StatCard>
                                        </Col>
                                        <Col xs={12} md={6} className="mt-2 pr-0">
                                            <StatCard title="Total Recovered" value={this.separator(this.state.dataArray.global_recovered)} color="#5AA001"></StatCard>
                                        </Col>
                                    </Row>
                                </Container>
                            </Col>
                            ...
                            <Col xs={12} className="pr-0 mt-2">
                                <Card text="white" style={{ minWidth: "15rem", backgroundColor: "#D1A000" }}>
                                    <Card.Body>
                                        ...
                                        <Card.Text style={{ fontSize: "48px" }}>{this.separator(this.state.dataArray.local_active_cases)}</Card.Text>
                                    </Card.Body>
                                </Card>
                            </Col>
                ...
                <Navbar bg="dark" variant="dark" className="mt-5">
                    ...
                    <Nav className="mr-auto">
                        <Nav.Link href="https://hpb.health.gov.lk/en/api-documentation?fbclid=IwAR0JWu_XtDsXHk5ZzN0xkYDd2V2Hc5-tQ7XHTO7Oh2FqJberHSNMbD1gzzs">Health Promotion Bureau</Nav.Link>
